    ...
    return (
      <div className="max-w-5xl mx-auto p-6 mt-5">
        ...
        <div className="text-center py-10">
          ...
          <p className="text-red-500 text-xl mb-4">{error || "آگهی پیدا نشد"}</p>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-2/3">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            {property.address && (
              <div className="p-6 border-b">
                <div className="flex items-start">
                  <svg className="w-6 h-6 ml-2 text-gray-500 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* گالری تصاویر */}
            <div className="p-6">
              <h3 className="font-semibold text-lg mb-4">تصاویر ({property.images?.length || 0})</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative w-full h-64 md:h-80 rounded-xl overflow-hidden bg-gray-100">
                    ...
                    {property.images.length > 1 && (
                      <>
                        <button
                          onClick={() => setIndex(i => i === 0 ? property.images!.length - 1 : i - 1)}
                        ...
                        <button
                          onClick={() => setIndex(i => i === property.images!.length - 1 ? 0 : i + 1)}
